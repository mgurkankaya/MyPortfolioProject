...
namespace PortfolioProject.Models
{
    ...
    public partial class PortfolioProjectEntities : DbContext
    {
        public PortfolioProjectEntities()
            : base("name=PortfolioProjectEntities")
        {
        }
        ...
        public virtual DbSet<TlbProjects> TlbProjects { get; set; }
